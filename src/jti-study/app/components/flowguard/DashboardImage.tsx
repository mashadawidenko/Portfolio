...
import imgRectangle7 from "../../../assets/erfj49949rkekkwo303.png";
  ...
  return (
    <div className={`absolute ${className}`}>
      <svg className="block w-full h-full" fill="none" viewBox="0 0 2112.6 2112.6">
        <g filter="url(#glow_filter_imerch)">
          <circle cx="1056.3" cy="1056.3" fill="#FF8228" fillOpacity="0.18" r="402.5" />
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="2112.6" id="glow_filter_imerch" width="2112.6" x="0" y="0">
