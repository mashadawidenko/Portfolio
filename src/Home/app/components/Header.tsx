...
export function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-b border-[#dadada]">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 py-4 md:py-8 flex items-center justify-between">
        ...
        <div className="flex gap-6 md:gap-16 items-center">
          ...
          <button className="flex gap-2.5 items-center justify-center pl-6 md:pl-8 pr-4 md:pr-6 py-2.5 rounded-full border border-[#323232]/40 hover:bg-[#f5f5f5] transition-colors">
