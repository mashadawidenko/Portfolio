...
>
        ...
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="order-2 lg:order-1 flex flex-col justify-between w-full lg:max-w-[700px]">
              {/* Заголовок + описание — СВЕРХУ, на уровне верха картинки */}
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <h3 className={`font-['Instrument_Sans',sans-serif] font-medium text-black text-[24px] md:!text-[36px] leading-[1.1] tracking-[-1px] ${isLinked ? 'group-hover:text-blue-400 transition-colors duration-300' : ''}`}>
                    {title}
                  </h3>
                </div>

                {/* Описание */}
                <p className="font-['Inter',sans-serif] text-[#424242] text-[14px] md:!text-[16px] leading-[1.6]">
                  {description}
                </p>
              </div>
              ...
              {isLinked && (
                <button className="w-full md:w-auto px-6 py-2.5 bg-black text-[#ffffff] rounded-[10px] font-['Inter',sans-serif] text-[15px] font-medium hover:bg-[#3F3F3F] transition-colors duration-300 flex items-center justify-center gap-2 mt-6">
        ...
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            <div className="flex items-center justify-between mb-8">
              <h3 className="font-['Instrument_Sans',sans-serif] font-medium text-black text-[18px] md:!text-[28px] leading-[24px] tracking-[-1px]">
                Design Concepts
              </h3>
