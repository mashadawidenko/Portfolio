...
const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Created a design system from scratch: 200 components, grid, typography, icons, color palette, spacing, and rounding; used tokens, auto-layouts, and components to speed up designer workflows;",
      "Developed logic and UX for complex cases where the story was incomplete or did not account for all business scenarios; independently formed user flows, detailed them, and coordinated with the business through the PM;",
      "Optimized key processes: in the 'Adding Equipment' case, reduced the number of screens by 30% while retaining all logic for all cases, ensuring user convenience and speed;",
      "Conducted analytics and clarified cases in parallel with design: created scenarios, detailed requirements, verified logic, identified inconsistencies, and collaborated with analysts and business teams;",
      "Constant interaction with the team: daily/weekly calls with the PM, business, and analysts; coordinated UX solutions, defended logic to the business, and resolved conflicts between business requirements and user convenience;",
      "UX-writing: prepared and adjusted texts for interfaces, including complex multi-step cases; interacted with lawyers and business teams to approve wording;",
      "Collaboration with developers (Android + backend): provided layouts, logic, and components, and consulted on the implementation of complex scenarios;",
      "Participated in forming key UX patterns for different user roles (merchandisers, retail, coordinators, foremen), ensuring interface consistency and ease of use;",
      "Responsible for most of the project's key modules for several months;",
      "Managed complex scenarios: combined repetitive screens, simplified action flows, and created convenient solutions for rare and non-standard cases (e.g., equipment outside the system, barcode not scanning, 'visit did not take place' lists);",
